...
sap.ui.define([
    ...
    function (ManagedObject) {
        ...
        return ManagedObject.extend("logaligroup.SAPUI5.controller.modulo_reutilizable1", {
            ...
            onPress_modulo_reutilizable1: function () {
                ...
                oView.byId("miInput1").setValue("Esta en la vista de nombre → " + viewName);
